# Banner ID: ca-app-pub-2200183060572685/2672540776
# Interestial ID: ca-app-pub-2200183060572685/3210762673
# Rewared ID: ca-app-pub-2200183060572685/3521087587
extends Node
...
# initialization
func init() -> bool:
	print_debug("Admob initialization")
